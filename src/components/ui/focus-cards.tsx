...
export const Card = React.memo(
  ({
    ...
    <div
      ...
      className={cn(
        "rounded-lg relative bg-gray-100 dark:bg-neutral-900 h-60 md:h-96 transition-all duration-300 ease-out max-w-5xl",
    ...
    >
      <Image
        ...
        alt={card.title}
        fill
        className="object-cover absolute inset-0 h-full sm:h-48 md:h-96 rounded-lg"
      />
      <div
        className={cn(
...
export function FocusCards({ cards }: { cards: Card[] }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 md:max-w-7xl mx-auto md:px-8 w-full rounded-lg">
