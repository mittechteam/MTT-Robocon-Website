    ...
    <div className={cn("relative", className)}>
      ...
      >
        <Image
          ...
          width={40000}
          height={1080}
          className="w-fit transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border"
        />
        <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
          <div className="bg-slate-900/10 flex items-center justify-center rounded-full backdrop-blur-md size-28 dark:bg-slate-50/10">
            <div
