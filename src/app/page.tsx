    ...
    <div className="flex flex-col md:flex-row items-center justify-between min-h-screen p-10">
      <div className="max-w-2xl mb-8 md:mb-0">
        ...
        <p className="mt-4 font-normal text-base text-justify text-neutral-300">
          At MIT-World Peace University, Pune, India, we are proud participants
          in the prestigious ABU Robocon event each year. With over 100 Indian
          teams competing annually, our team stands out as one of the top
          robotics teams in the country.
        </p>
      </div>
